...
/**
 * La classe <code>VueProtocoleDev</code> affiche l'interface pour choisir son protocole
 *  
 * @version 1.4
 * @author Oscar Williatte et Edouard Schnur et Hassan Meite
 */

public class VueProtocoleDev extends JFrame {
    /**
	...
	ControlerProtocoleDev ctrl = new ControlerProtocoleDev(this,this.panelProtocole,champ);
